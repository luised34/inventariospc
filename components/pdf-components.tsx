...
export function PDFComponents({ maintenance, equipment, technician }) {
  return (
    <>
      <div className="flex justify-end mb-4">
        <PDFDownloadLink
          document={<MaintenancePDF maintenance={maintenance} equipment={equipment} technician={technician} />}
          fileName={`mantenimiento_${maintenance.numeroSolicitud}.pdf`}
      ...
      <PDFViewer style={{ width: "100%", height: "100%" }}>
        <MaintenancePDF maintenance={maintenance} equipment={equipment} technician={technician} />
      </PDFViewer>
    </>
  )
}
